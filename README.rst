...
Clone repo::
    ...
    $ git clone git@gitlab.intern.rheinwerk.de:rheinwerk/planning-poker-jira
...
... or create a virtualenv and install tox into it::
    ...
    $ mkvirtualenv planning-poker-jira
    (planning-poker-jira)$ pip install tox
