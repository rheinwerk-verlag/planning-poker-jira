...
def apply_settings():
    ...
    if getattr(settings, 'PLANNING_POKER_JIRA_IMPORTANT') is None:
        raise ImproperlyConfigured('Please make sure you specified a PLANNING_POKER_JIRA_IMPORTANT setting.')
